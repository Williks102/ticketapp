      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${
        ...
        <div className="absolute bottom-0 w-full p-4 border-t">
          ...
          <div className="mt-2 px-4">
            <Link 
              href="/"
              className="flex items-center justify-center w-full px-3 py-2 text-sm text-gray-600 hover:text-gray-900 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors"
            >
